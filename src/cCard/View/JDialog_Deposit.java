...
public class JDialog_Deposit extends javax.swing.JDialog
{
	...
	public JDialog_Deposit(Card parent, String aname)
	{
		super(parent);
		parentframe=parent;
		name=aname;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		String num=null;
        if (selection >=0) {
        	num=(String)parentframe.getModel().getValueAt(selection, 1);
        	this.main.deposit(CCDB.findAccountByNumber(Long.parseLong(num)), Double.parseDouble(parentframe.amountDeposit));
        }
        dispose();
	}
