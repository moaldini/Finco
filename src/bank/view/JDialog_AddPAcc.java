...
public class JDialog_AddPAcc extends javax.swing.JDialog
{
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
       ...
       Person p= new Person(parentframe.clientName,"emailAdress","dateOfbirth",a);
       BankAccount account;
       if (JRadioButton_Chk.isSelected()) {
           parentframe.accountType="Ch";
           account= new Chekings(Long.parseLong(parentframe.accountnr));}
           else
           {parentframe.accountType="S";
           account= new Savings(Long.parseLong(parentframe.accountnr));}
       main.addPersonalAccount(p, account);
       BankDB.print();
